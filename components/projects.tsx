...
export default function Projects() {
  ...
  return (
    <section id="projects" ref={sectionRef} className="py-20 px-4 section-fade-in">
          ...
          {projects.map((project, index) => {
            ...
            return (
              <Card
                ...
                } bg-card/95 backdrop-blur-sm shadow-2xl border-primary/20 hover:shadow-primary/20`}
                style={{
              ...
              >
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    <CardTitle className="text-2xl font-serif text-primary">{project.title}</CardTitle>
                    <span className="text-sm text-muted-foreground font-medium whitespace-nowrap ml-2">
                      {project.date}
                    </span>
                  </div>
                </CardHeader>
