  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 px-4 bg-muted/30 section-fade-in">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto lg:ml-32">
          <div className="flex flex-col items-start space-y-6">
            <div className="flex items-center gap-4 group hover:scale-105 hover:-translate-y-1 transition-all duration-300 cursor-pointer transform-gpu">
              <div className="w-14 h-14 flex items-center justify-center bg-primary/10 rounded-lg group-hover:bg-primary group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shrink-0">
