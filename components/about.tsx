        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              my Master's in Data Science at Arizona State University. With over 3 years of experience in AI/ML, I
              specialize in developing innovative solutions using cutting-edge technologies like Deep Learning, Computer
              Vision, and Natural Language Processing.
            </p>

            <p className="text-lg text-muted-foreground leading-relaxed">
              My expertise spans from building end-to-end ML pipelines to deploying scalable AI applications. I've
              ...
              through data-driven approaches and creating impactful AI solutions.
            </p>
          </div>
